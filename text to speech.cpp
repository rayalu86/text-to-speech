...
int main()
{
    ...
    {
        cout<<"******************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE PAVAN |"<<endl;
        cout<<"******************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU PAVAN";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="pavan")
        {
            ...
            do{
                cout<<"\n<********************************>\n\n";
                cout<<endl<<"How can i help you dear...."<<endl<<endl;

                string phrase = "How can i help you dear";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"I'm a personal assistant created by Pavan !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Pavan !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye Pavan, see you soon!"<<endl;
                    string phrase = "Good Bye Pavan, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
        ...
        else
                {
                    ...
                    ing phrase = "Incorrect Password, please enter correct password";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
